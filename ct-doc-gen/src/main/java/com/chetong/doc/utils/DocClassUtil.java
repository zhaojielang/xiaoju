...
public class DocClassUtil {
	...
	public static final String CHAR_TYPE_NAME = "int";
	public static final String STRING_TYPE_NAME = "string";
	public static final String DATE_TYPE_NAME = "date";
	public static final String MAP_TYPE_NAME = "map";
	public static final String LIST_TYPE_NAME = "list";
	public static final String PAGE_LIST_TYPE_NAME = "pagelist";
	public static final String JSON_OBJ_TYPE_NAME = "jsonObj";
	public static final String JSON_ARR_TYPE_NAME = "jsonArr";
	public static final String FORMAT_TYPE_NAME = "format";
	public static final String FORMAT_TYPE_PACKAGE = "java.text";
	public static final String OBJ_TYPE_NAME = "obj";
